    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <Input
          ...
          customStyle={{ borderBottomWidth: 0 }}
        />
        <NumericInput maxValue={50} containerStyle={{borderWidth: 1, borderRadius: 20, marginHorizontal: 20, backgroundColor: '#eee'}} minValue={0} type='plus-minus' onChange={value => setAge(value)} />
        ...
        <Text style={{ marginLeft: 30, marginTop: 10, fontWeight: "bold" }}>
          Select shifts
        </Text>
        ...
        {loading ? (
          ...
          <Button on title="Create" onPress={createData} />
        )}
      </ScrollView>
    </SafeAreaView>
  );
